...
class FilterCliente with ChangeNotifier{
    ...
    return Wrap(
      children: <Widget>[
        FindDropdown(
          ...
          items: ['Seleccione','nombre','apellido','email','telefono','celular'],
  ...
  Future<List<ClienteModel>> obtenerClienteFiltro()async{
    List<ClienteModel> lista=await DBProvider.db.filterAdvanceCliente(_query);
    return lista;
  }
}